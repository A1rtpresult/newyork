...
function loadtop10result(sar, prize123 = 0) {
    ...
    for (p = 0; p < top10result.length; p++) {
        ...
        if (sar == "m24") {
            ...
            if (valuebanker.substr(0, 4) == "bull") {
                valuebanker = valuebanker.substr(0, 4);
            } else {
                valuebanker = valuebanker;
            }
            if (valueplayer1.substr(0, 4) == "bull") {
                valueplayer1 = valueplayer1.substr(0, 4);
            } else {
                valueplayer1 = valueplayer1;
            }
            if (valueplayer2.substr(0, 4) == "bull") {
                valueplayer2 = valueplayer2.substr(0, 4);
            } else {
                valueplayer2 = valueplayer2;
            }
            if (valueplayer3.substr(0, 4) == "bull") {
                valueplayer3 = valueplayer3.substr(0, 4);
            } else {
                valueplayer3 = valueplayer3;
            }
        }
